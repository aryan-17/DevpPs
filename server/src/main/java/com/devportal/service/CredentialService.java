...
public class CredentialService {
    ...
    public Credential create(UUID envId, UUID projectId, String key, String valuePlain, String type, String description, User user, String ip) {
        Project project = getProjectInEnv(envId, projectId);
    ...
    public Credential update(UUID envId, UUID projectId, UUID credentialId, String key, String valuePlain, String type, String description, User user, String ip) {
        Project project = getProjectInEnv(envId, projectId);
